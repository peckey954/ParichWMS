...
export type ModuleItem = {
  ...
  label: string;
  /**
   * ชื่อเรียกสั้น ๆ ที่คนใช้เรียกกันจริง — ใช้เป็นคำค้นเพิ่มเท่านั้น ไม่ได้เอาไปแสดง
   *
   * เดิมเอาไว้แสดงแทนชื่อเต็มบนจอแคบ แต่ตอนนี้การ์ดบนมือถือเต็มความกว้างแล้ว
   * ชื่อเต็มห่อบรรทัดได้ ไม่ต้องย่อ จึงเหลือหน้าที่เดียวคือให้ searchModules
   * หาเจอเวลาคนพิมพ์ชื่อที่เคยชิน
   */
  shortLabel?: string;
  code: string;
